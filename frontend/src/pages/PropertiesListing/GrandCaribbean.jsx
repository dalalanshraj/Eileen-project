...
const GrandCaribbeanFront = () => {
  ...
  const propertyId = "68f7edf6fa0cfc5e57cebeb0";
  ...
  const openPreviewModal = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        ...
        {
          propertyId: "68f7edf6fa0cfc5e57cebeb0",
  ...
  const images = [
    "https://www.coastaldreamrentals.com/img/property-img3/img-1.jpg",
    "https://www.coastaldreamrentals.com/img/property-img3/img-2.jpg",
    "https://www.coastaldreamrentals.com/img/property-img3/img-3.jpg",
    "https://www.coastaldreamrentals.com/img/property-img3/img-4.jpg",
  ];
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-xl relative z-30">
            <p className="text-gray-500 text-sm mb-2">
              Florida • Destin • PropertyID 7445
            </p>
            <h1 className="text-4xl font-bold mb-4">Grand Caribbean West</h1>
        ...
        <div className="relative">
          <div className="sticky top-38 bg-white shadow-lg rounded-2xl p-6">
            ...
            <div className="text-center mt-6 border-t pt-4">
              ...
              <p className="text-pink-600 font-bold">📞 404-275-6533</p>
            </div>
          </div>
        </div>
      </div>
...
export default GrandCaribbeanFront;
